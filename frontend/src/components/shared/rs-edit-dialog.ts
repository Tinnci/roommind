...
export class RsEditDialog extends LitElement {
  ...
  @property({ type: String }) public doneLabel = "Done";
  @property({ type: String }) public supportingText = "";
  ...
  static override styles = [
    ...
    css`
      ...
      .backdrop {
        position: absolute;
        inset: 0;
        background: var(--roommind-dialog-backdrop);
        display: flex;
      ...
      .dialog {
        background: var(--roommind-dialog-surface);
        color: var(--primary-text-color);
        border-radius: var(--roommind-radius-card, 8px);
        box-shadow: var(--roommind-shadow-dialog);
        width: 100%;
        max-width: 760px;
        display: flex;
      ...
      .info-panel {
        ...
        border: 1px solid var(--roommind-primary-border);
        border-radius: var(--roommind-radius-card, 8px);
        font-size: 13px;
        line-height: 1.6;
        color: var(--primary-text-color);
