...
RAW_OBSERVATION_RETENTION_DAYS = 14
OBSERVATION_INTERVAL_RETENTION_DAYS = 365
OBSERVED_SUMMARY_BUCKET_SECONDS = 300
OBSERVED_SUMMARY_RETENTION_DAYS = 365
THERMAL_EPISODE_RETENTION_DAYS = 365
THERMAL_EPISODE_MIN_DURATION_SECONDS = 20 * 60
THERMAL_EPISODE_MAX_GAP_SECONDS = 10 * 60
RAW_OBSERVATION_PRUNE_CYCLES = HISTORY_ROTATE_CYCLES
